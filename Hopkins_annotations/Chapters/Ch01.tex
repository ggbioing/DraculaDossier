...
Bistritz.
\footnote{CUSHING: IVOR insisted that the Securitate intel comes from "near Bistritz". ?? intel's attempt to id. a conventional channel between Securitate and any suspected ?? assuming this was a ??, and assuming CI's efforts were genuine and thorough, what possibilities remain? Ivor is wrong; Ivor is lying; channel is ??}
